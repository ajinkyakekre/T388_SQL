...
Select concat(Fullname,"-",department) as "data" from employee;
...
Select fullname , replace(Fullname,"Jones","Sangakara") as changed from employee;

Select reverse(Fullname) from employee;


Select fullname , replace(Fullname,"Jones","Sangakara") as changed,reverse(Fullname) from employee;
...
Select * ,ltrim(Fullname) from trimmer;
Select * ,rtrim(Fullname) from trimmer;

select fullname, length(FULLNAME) as Actual_Length,ltrim(FULLNAME) as LeftTrim ,
length(ltrim(FULLNAME)) as LTRIM_Length,rtrim(FULLNAME) as RightTrim ,Length(rtrim(FULLNAME)) as RTRIM_Length from trimmer;
...
-- Query from second highest salary (employeetable)
select Max(salary) from employee ;
select max(salary) from employee where salary < (select Max(salary) from employee);

-- Query from third highest salary (employeetable)
...
select * from employee where salary< all(select salary from employee where employeeid between 1003 and 1005) ;


select * from employee where salary< all(select salary from employee where employeeid in (1003,1005)) ;
